...
public:
  Order(OrderType orderType, OrderId orderId, Side side, Price price,
        Quantity quantity)
      : orderId_{orderId}, orderType_{orderType}, side_{side}, price_{price},
...
public:
  ...
  OrderBookLevelInfos GetOrderInfos() const {
    ...
    for (const auto& [price, bidOrders] : bids_) {
      bidInfos.push_back(CreateLevelInfos(price, bidOrders));
    }
    for (const auto& [price, askOrders] : asks_) {
      askInfos.push_back(CreateLevelInfos(price, askOrders));
    }
